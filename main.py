...
class MenuPage:
    ...
    def to_crypt_decrypt_software(self)-> None:
        crypt_decrypt_page.init()

    def to_pwd_gen(self)-> None:
        random_password_generator_page.init()

    def to_manage_pwd(self)-> None:
...
def change_palet(choice:str)-> None:
    global primary_color, primary_color_hover, secondary_color, secondary_color_hover, text_color, text_color_hover, is_running
    datas.palet = choice
    if choice == "Dark" or choice == "Sombre":
